  ...
  return (
    <section id="work" className="relative bg-black text-white py-32 md:py-48 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1500px] mx-auto px-6 md:px-12">
        ...
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-32 md:mb-48 border-b border-white/10 pb-8">
           <div>
        ...
        <div className="space-y-32 md:space-y-64">
          {projects.map((proj, idx) => {
            ...
            return (
               ...
               >
                 {/* Image */}
                 <div className={`md:col-span-8 w-full aspect-video bg-zinc-900 overflow-hidden relative ${isEven ? 'order-1' : 'order-1 md:order-2'}`}>
                    <Image 
                      src={proj.img}
                      alt={proj.title}
                      fill
                 ...
                 <div className={`md:col-span-4 flex flex-col justify-center space-y-6 ${isEven ? 'order-2' : 'order-2 md:order-1'}`}>
                    ...
                    <a href="#" className="inline-flex items-center gap-4 text-white text-[10px] tracking-[0.2em] font-bold uppercase hover:text-zinc-400 transition-colors pt-6 group/link">
                       View Project 
